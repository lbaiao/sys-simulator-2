...
MAX_NUM_EPISODES = 600 * NUMBER      # medium training
ITERATIONS_PER_NUM_AGENTS = 100
EVAL_EVERY = 30 * NUMBER
...
EPSILON_DECAY = 1.5/(MAX_NUM_EPISODES*STEPS_PER_EPISODE)  # medium training
PRIO_BETA_ITS = int(.7*MAX_NUM_EPISODES*STEPS_PER_EPISODE)
