...
MAX_NUM_EPISODES = 800 * NUMBER      # medium training
ITERATIONS_PER_NUM_AGENTS = 100
EVAL_EVERY = 40 * NUMBER
...
EPSILON_DECAY = 1.8/(MAX_NUM_EPISODES*STEPS_PER_EPISODE)  # medium training
PRIO_BETA_ITS = int(.6*MAX_NUM_EPISODES*STEPS_PER_EPISODE)
