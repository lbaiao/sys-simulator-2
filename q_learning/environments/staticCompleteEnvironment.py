...
class StaticCompleteEnvironment(RLEnvironment):
    """
    ...
    def __init__(self, params: EnvironmentParameters, reward_function, **kwargs):
        ...
        super(StaticCompleteEnvironment, self).__init__(params, reward_function, **kwargs)
        self.states = [0,0,1]
    ...
    def build_scenario(self, agents: List[DistanceAgent]):
        ...
        if len(agents) != 4:
            raise 'number of agents must be 4'
        ...
        gen.distribute_mue_validation([self.mue], self.bs)
        gen.distribute_d2d_validation(self.d2d_pairs, self.bs)
