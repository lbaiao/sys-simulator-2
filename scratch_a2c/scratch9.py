...
from sys_simulator.a2c.a2c import A2CLSTMDiscrete


def test(env: CompleteEnvironmentA2C2, a2c: A2CLSTMDiscrete,
         max_d2d: int, num_episodes: int,
    ...
    for ep in range(num_episodes):
        actor_h, actor_c = a2c.initHidden()
...
def run():
    ...
    a2c = A2CLSTMDiscrete(environment.state_space_size,
                          NUM_ACTIONS, HIDDEN_SIZE, NUM_RNN_LAYERS)
    a2c.load_state_dict(
        torch.load(f'{cwd}/models/a2c/script9_actor.pt')
    )
    ...
    mue_spectral_effs, d2d_spectral_effs, bag, = \
        test(environment, a2c, MAX_NUMBER_OF_AGENTS,
