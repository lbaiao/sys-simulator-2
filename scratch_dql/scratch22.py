# Simulations taking pictures of the users distributions. It uses script26 model.
...
from plots.plots import plot_positions_and_actions
...
# policy 5 test
aux_range = list(range(11))[1:] + [10,15,20]
