#  Similar to scratch20.py. We also measure how many times the devices
#  chose the same tx power. We use script26 model. We simulate for N_D2D=1 till 10
#  it uses script30 model
...
framework.policy_net.load_state_dict(torch.load(f'{lucas_path}/models/script29.pt'))
