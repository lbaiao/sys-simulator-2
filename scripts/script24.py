...
agent_params = DQNAgentParameters(EPSILON_MIN, EPSILON_DECAY, 1, 10000, 512, GAMMA)
...
def train(framework: ExternalDQNFramework, env: CompleteEnvironment3, params: TrainingParameters, agent_params: DQNAgentParameters, max_d2d: int):    
