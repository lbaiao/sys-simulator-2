# Same as script1, but with CompleteEnvironmentA2C2
...
from sys_simulator.a2c import ActorCritic, compute_gae_returns
...
def run():
    ...
    # a2c initialization
    a2c = ActorCritic(environment.state_space_size,
                      environment.action_space_size, HIDDEN_SIZE, mu, std)
    ...
    while episode < MAX_NUM_EPISODES:
        ...
        d2d_spectral_effs.append(environment.d2d_spectral_eff.cpu().numpy())
        mue_spectral_effs.append(environment.mue_spectral_eff.cpu().numpy())
