...
from sys_simulator.a2c.a2c import A2CLSTMDiscrete, compute_gae_returns
...
def run():
    ...
    a2c_optimizer = optim.SGD(a2c.parameters(), lr=LEARNING_RATE)
    ...
    while episode < MAX_NUM_EPISODES:
        ...
        for j, agent in enumerate(agents):
            next_value_t = a2c.critic(next_obs_t[j])
