...
def train(env: CompleteEnvironment11, start: float, writer: SummaryWriter):
...
def test(env: CompleteEnvironment11, framework: Framework):
...
def run():
    ...
    train_bags = train(env, start, writer)
