...
from devices.devices import d2d_user, mobile_user, d2d_node_type

from scipy.spatial.distance import euclidean


def sinr_d2d(d2d_tx: d2d_user, d2d_devices, mue: mobile_user, noise_power):
...
def sinr_mue(mue: mobile_user, d2d_devices, bs, noise_power):
