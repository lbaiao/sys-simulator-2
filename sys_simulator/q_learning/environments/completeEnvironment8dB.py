...
class CompleteEnvironment8dB(RLEnvironment):
    """
    Similar to CompleteEnvironment7dB, but the channel is dynamic, and the
    ...
    def __init__(self, params: EnvironmentParameters,
                 ...
                 n_closest_devices=1, reward_penalty=1,
                 **kwargs):
        self.params = params
        super(CompleteEnvironment8dB, self).__init__(params,
    ...
    def set_scenario(self, pairs_positions: List[Tuple],
        ...
        self.sinr_d2ds = []
        self.rb = 1
        self.bs = base_station((0, 0, 25), radius=self.params.bs_radius)
        self.bs.set_gain(self.params.bs_gain)
        # mue stuff
        self.mue = mobile_user(0, self.params.p_max)
        self.mue.set_gain(self.params.user_gain)
    ...
    def calculate_d2d_pathlosses(self):
        for tx, rx in self.d2d_pairs:
            ...
            pathloss_to_rx = self.channel.step(
    ...
    def sinr_d2d(self, d2d_tx: d2d_user, d2d_rx: d2d_user,
        ...
        # interference caused by the MUE
